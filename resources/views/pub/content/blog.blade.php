...
<div class="col-sm-12">
    <article class="content">
        ...
        @auth
            ...
            @if ($blog->publish === 1)
            <a href="{{ Route('StopPublish', $blog->id) }}" class="btn btn-danger btn-lg mt-4 justify-content-center ">
                ايقاف النشر
            </a>
              @else
              <a href="{{ Route('StopPublish', $blog->id) }}" class="btn btn-success btn-lg mt-4 justify-content-center ">
                  نشر
              </a>
            @endif
            @endif
        ...
        <div class="date">
            <ul>
                <li>بواسطة <span>
                        <font color="red"> Abowael </font>
                    </span> --</li>
                <li>التاريخ <span>
                        <font color="red">{{$blog->created}}</font>
                    </span> --</li>
                <li>مشاهدة<span>
                        <font color="red">{{$blog->view}} </font>
                    </span></li>
            </ul>
        </div>
        {!! $blog->content !!}
